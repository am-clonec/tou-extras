...
public sealed class InfiltratorTransportButton : TownOfUsRoleButton<InfiltratorRole>
{
    public override string Name => "Transport";
    public override Color TextOutlineColor => new Color32(255, 69, 0, 255); // Red-orange

    public override float Cooldown =>
        Math.Clamp(OptionGroupSingleton<InfiltratorOptions>.Instance.TransportCooldown, 5f, 120f);
