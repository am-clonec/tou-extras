...
public sealed class SentinelTransportButton : TownOfUsRoleButton<SentinelRole>
{
    public override string Name => "Transport";
    public override Color TextOutlineColor => new Color32(173, 216, 230, 255); // Light blue

    public override float Cooldown =>
        Math.Clamp(OptionGroupSingleton<SentinelOptions>.Instance.ExplodeCooldown + MapCooldown, 5f, 120f);
            ...
            plr =>
            {
                ...
                player2Menu.Begin(
                    ...
                    plr2 =>
                    {
                        ...
                        SentinelRole.RpcTransport(PlayerControl.LocalPlayer, plr.PlayerId, plr2.PlayerId);
                    }
                );
